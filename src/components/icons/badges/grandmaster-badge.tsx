...
export function GrandmasterBadge(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <path d="M12 12.5 l2.35 1.5 l-0.9-2.75 l2.3-1.6h-2.85L12 7.5l-0.9 2.15H8.25l2.3 1.6 l-0.9 2.75Z" fill="#FFD700" transform="translate(0, 6.5) scale(0.5)"/>
    </svg>
  );
}
