...
export function CelestialBadge(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <path d="m9 13 3-3 3 3" stroke="#FFD700" strokeWidth="2"/>
      ...
      <path d="M12 12.5 l2.35 1.5 l-0.9-2.75 l2.3-1.6h-2.85L12 7.5l-0.9 2.15H8.25l2.3 1.6 l-0.9 2.75Z" fill="#FFD700" transform="translate(-3, 8) scale(0.5)"/>
      <path d="M12 12.5 l2.35 1.5 l-0.9-2.75 l2.3-1.6h-2.85L12 7.5l-0.9 2.15H8.25l2.3 1.6 l-0.9 2.75Z" fill="#FFD700" transform="translate(3, 8) scale(0.5)"/>
    </svg>
  );
}
